...
&PARAM_MAPPROJECTION
 MAPPROJECTION_basepoint_lon = ${MAPPROJECTION_BASEPOINT_LON[$D]},
 MAPPROJECTION_basepoint_lat = ${MAPPROJECTION_BASEPOINT_LAT[$D]},
