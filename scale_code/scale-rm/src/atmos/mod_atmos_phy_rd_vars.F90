...
module mod_atmos_phy_rd_vars
  ...
  real(RP), public, allocatable :: ATMOS_PHY_RD_SFLX_SW_dn_net_sprintars(:,:) ! downward shortwave flux [J/m2/s] = [W/m2] ### for SPRINTARS
  real(RP), public, allocatable :: ATMOS_PHY_RD_dtau_s                (:,:,:) ! 0.67 micron cloud optical depth ### for SPRINTARS
...
contains
  ...
  subroutine ATMOS_PHY_RD_vars_setup
    ...
    ! ### for SPRINTARS
    allocate( ATMOS_PHY_RD_SFLX_SW_dn_net_sprintars(IA,JA) )
    allocate( ATMOS_PHY_RD_dtau_s(KA,IA,JA) )
    ATMOS_PHY_RD_SFLX_SW_dn_net_sprintars(:,:) = 0.0_RP
    ATMOS_PHY_RD_dtau_s(:,:,:) = 0.0_RP
    !$acc enter data create(ATMOS_PHY_RD_SFLX_SW_dn_net_sprintars,ATMOS_PHY_RD_dtau_s)
