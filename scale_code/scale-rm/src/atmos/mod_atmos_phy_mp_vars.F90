...
module mod_atmos_phy_mp_vars
  ...
  real(RP), public, allocatable :: ATMOS_PHY_MP_mflux_qr_total  (:,:,:)   ! precipitation flux (liquid) [kg/m2/s] ### for SPRINTARS
  real(RP), public, allocatable :: ATMOS_PHY_MP_mflux_qs_total  (:,:,:)   ! precipitation flux (solid)  [kg/m2/s] ### for SPRINTARS
  real(RP), public, allocatable :: ATMOS_PHY_MP_vterm_rain      (:,:,:)   ! terminal velocity of rain   [m/s]     ### for SPRINTARS
  real(RP), public, allocatable :: ATMOS_PHY_MP_vterm_snow      (:,:,:)   ! terminal velocity of snow   [m/s]     ### for SPRINTARS
  real(RP), public, allocatable :: ATMOS_PHY_MP_RHOQ_t_SPRINTARS(:,:,:,:) ! tendency rho*QTRC           [kg/m3/s] ### for SPRINTARS
...
contains
  ...
  subroutine ATMOS_PHY_MP_vars_setup
    ...
    ! ### for SPRINTARS
    allocate( ATMOS_PHY_MP_mflux_qr_total  (0:KA,IA,JA)             )
    allocate( ATMOS_PHY_MP_mflux_qs_total  (0:KA,IA,JA)             )
    allocate( ATMOS_PHY_MP_vterm_rain      (KA,  IA,JA)             )
    allocate( ATMOS_PHY_MP_vterm_snow      (KA,  IA,JA)             )
    allocate( ATMOS_PHY_MP_RHOQ_t_SPRINTARS(KA,  IA,JA,QS_MP:QE_MP) )
    ATMOS_PHY_MP_mflux_qr_total  (:,:,:)   = 0.0_RP
    ATMOS_PHY_MP_mflux_qs_total  (:,:,:)   = 0.0_RP
    ATMOS_PHY_MP_vterm_rain      (:,:,:)   = 0.0_RP
    ATMOS_PHY_MP_vterm_snow      (:,:,:)   = 0.0_RP
    ATMOS_PHY_MP_RHOQ_t_SPRINTARS(:,:,:,:) = 0.0_RP
    !$acc enter data create(ATMOS_PHY_MP_mflux_qr_total,ATMOS_PHY_MP_mflux_qs_total,ATMOS_PHY_MP_vterm_rain,ATMOS_PHY_MP_vterm_snow,ATMOS_PHY_MP_RHOQ_t_SPRINTARS)
...
!OCL XFILL
    ...
    DIAG_Qe      = .false.
    DIAG_Ne      = .false.
    !$acc enter data create(ATMOS_PHY_MP_CLDFRAC, ATMOS_PHY_MP_Re, ATMOS_PHY_MP_Qe, ATMOS_PHY_MP_Ne)
  ...
  subroutine ATMOS_PHY_MP_vars_finalize
    ...
    deallocate( ATMOS_PHY_MP_MOMX_t     )
    deallocate( ATMOS_PHY_MP_MOMY_t     )
...
!!$    endif
  ...
  !-----------------------------------------------------------------------------
  !> Read restart
  subroutine ATMOS_PHY_MP_vars_restart_read(DENS, RHOT, QTRC)
    use scale_file, only: &
       FILE_get_aggregate
    use scale_file_cartesC, only: &
       FILE_CARTESC_read, &
...
!OCL XFILL
  ...
  subroutine ATMOS_PHY_MP_vars_check
...
!!$                           ATMOS_GRID_CARTESC_REAL_TOTAREA      ) ! (in)
    ...
    return
  end subroutine ATMOS_PHY_MP_vars_check
