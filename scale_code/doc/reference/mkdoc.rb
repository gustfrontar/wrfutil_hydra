...
files.each do |fname|
  ...
  data = Hash.new
  case fname
  when /scale_atmos_phy_mp_amps\.F90/
    fnames.push File.join(File.dirname(fname), "../../../../../contrib/AMPS/com_amps.F90")
  when /scale_atmos_phy_mp_sdm\.F90/
    fnames.push File.join(File.dirname(fname), "../../../../../contrib/SDM/sdm_common.f90")
  end
  fnames.each do |fn|
