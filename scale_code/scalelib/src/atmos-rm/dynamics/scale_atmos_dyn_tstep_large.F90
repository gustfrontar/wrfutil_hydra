...
contains
  ...
  subroutine ATMOS_DYN_Tstep_large_setup( &
    ...
    use scale_atmos_dyn_tstep_large_dgm_heve, only: &
       ATMOS_DYN_Tstep_large_dgm_heve_setup,    &
       ATMOS_DYN_Tstep_large_dgm_heve_finalize, &
       ATMOS_DYN_Tstep_large_dgm_heve
    implicit none
    ...
    case( 'DGM-HEVE' )
      call ATMOS_DYN_Tstep_large_dgm_heve_setup( &
            DENS, MOMZ, MOMX, MOMY, RHOT, QTRC, PROG )
      ATMOS_DYN_Tstep_large => ATMOS_DYN_Tstep_large_dgm_heve
      ATMOS_DYN_Tstep_large_finalize => ATMOS_DYN_Tstep_large_dgm_heve_finalize  
    case default
