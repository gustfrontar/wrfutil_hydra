...
!-------------------------------------------------------------------------------
#include "scalelib.h"
module scale_atmos_dyn_tstep_short_dgm_hevi
  !-----------------------------------------------------------------------------
  !
  !++ used modules
  !
  ...
  !++ Public procedure
  !
  public :: ATMOS_DYN_Tstep_short_dgm_hevi_regist
  public :: ATMOS_DYN_Tstep_short_dgm_hevi_setup
  public :: ATMOS_DYN_Tstep_short_dgm_hevi_ex
  public :: ATMOS_DYN_Tstep_short_dgm_hevi_vi
...
contains
  !-----------------------------------------------------------------------------
  !> Register
  subroutine ATMOS_DYN_Tstep_short_dgm_hevi_regist( &
       ATMOS_DYN_TYPE, &
       VA_out,         &
       VAR_NAME,       &
       VAR_DESC,       &
    ...
    if ( ATMOS_DYN_TYPE /= 'DGM-HEVI' ) then
       LOG_ERROR("ATMOS_DYN_Tstep_short_dgm_hevi_regist",*) 'ATMOS_DYN_TYPE is not DGM-HEVI. Check!'
       call PRC_abort
    endif
    ...
    LOG_NEWLINE
    LOG_INFO("ATMOS_DYN_Tstep_short_dgm_hevi_regist",*) 'Register additional prognostic variables (HEVI)'
    if ( VA_out < 1 ) then
       LOG_INFO_CONT(*) '=> nothing.'
    endif

    return
  end subroutine ATMOS_DYN_Tstep_short_dgm_hevi_regist

  !-----------------------------------------------------------------------------
  !> Setup
  subroutine ATMOS_DYN_Tstep_short_dgm_hevi_setup
    return
  end subroutine ATMOS_DYN_Tstep_short_dgm_hevi_setup

  !-----------------------------------------------------------------------------
  subroutine ATMOS_DYN_Tstep_short_dgm_hevi_ex( &
    ...
    return
  end subroutine ATMOS_DYN_Tstep_short_dgm_hevi_ex

  subroutine ATMOS_DYN_Tstep_short_dgm_hevi_vi( &
    DENS_dt, MOMX_dt, MOMY_dt, MOMZ_dt, RHOT_dt,             & ! (out)
    ...
    use scale_atmos_dyn_tstep_short_dgm_hevi_common, only: &
      vi_gen_vmap => atmos_dyn_tstep_short_dgm_hevi_common_gen_vmap,                  &
      vi_eval_Ax => atmos_dyn_tstep_short_dgm_hevi_common_eval_Ax,                    &
      vi_eval_Ax_uv => atmos_dyn_tstep_short_dgm_hevi_common_eval_Ax_uv,              &
      vi_construct_matbnd => atmos_dyn_tstep_short_dgm_hevi_common_construct_matbnd,  &
      vi_construct_matbnd_uv => atmos_dyn_tstep_short_dgm_hevi_common_construct_matbnd_uv
    ...
    do ke_z=1, lmesh%NeZ
      ...
      GnnM_z(:,ke_z,ke_xy) = ( &
        ...
        + G23_z(:,ke_z,ke_xy) * lmesh%GIJ(elem%IndexH2Dto3D,ke2D,2,2) * G23_z(:,ke_z,ke_xy)  )
    end do
    end do
    !$omp end do
    !$omp workshare
...
#else
            LOG_ERROR('ATMOS_DYN_Tstep_short_dgm_hevi_vi',*) 'Binary not compiled specifying SCALE_MATHLIB_LIBS! STOP.'
            call PRC_abort
#endif
    ...
    return
  end subroutine ATMOS_DYN_Tstep_short_dgm_hevi_vi
...
end module scale_atmos_dyn_tstep_short_dgm_hevi
