...
!!
!! @par Description
!!      HEVE DGM scheme for tracer advection in Atmospheric dynamical process
!!
...
!<
#include "scalelib.h"
module scale_atmos_dyn_tstep_tracer_dgm_heve
  !-----------------------------------------------------------------------------
  !
  !++ Used modules
  !
  ...
  !++ Public procedures
  !
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_setup
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_finalize
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_calc_fct_coef  
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_cal_tend
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_TMAR
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_save_massflux
  public :: ATMOS_DYN_Tstep_tracer_dgm_heve_cal_alphdens_advtest
...
!OCL SERIAL
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_setup( type )
    use scale_prc, only: &
       PRC_abort
    implicit none
    character(len=*), intent(in) :: type

    if ( type /= 'DGM-HEVE' ) then
       LOG_ERROR("ATMOS_DYN_Tstep_tracer_dgm_heve_setup",*) 'Tstep_tracer_type is not "DGM-HEVE"!'
       call PRC_abort
    end if

    return
  end subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_setup
  
!OCL SERIAL  
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_finalize()
    implicit none
    !--------------------------------------------

    return    
  end subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_finalize


!OCL SERIAL
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_cal_tend( &
    QTRC_dt,                                        & ! (out)
    ...
    type(SparseMat), intent(in) :: Dx, Dy, Dz, Lift, FaceIntMat
    ...
    return
  end subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_cal_tend

!OCL SERIAL
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_calc_fct_coef( &
    fct_coef,                                                     & ! (out)
    ...
    return
  end subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_calc_fct_coef


!OCL SERIAL
!> Second Step of limiter in which nonlinear truncation and mass aware rescaling (TMAR)
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_TMAR( QTRC_,  & ! (inout)
    ...
    return
  end subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_TMAR

!OCL SERIAL
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_save_massflux( &
...
!OCL SERIAL
  subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_cal_alphdens_advtest( alph_dens_M, alph_dens_P, &
    ...
    return
  end subroutine ATMOS_DYN_Tstep_tracer_dgm_heve_cal_alphdens_advtest
...
end module scale_atmos_dyn_tstep_tracer_dgm_heve