!-------------------------------------------------------------------------------
!> module File / FEM field data / Base
!!
!! @par Description
!!          A base module for outputting FEM data with MeshField type 
!!
!! @author Yuta Kawai, Team SCALE
!<
!-------------------------------------------------------------------------------
#include "scalelib.h"
module scale_file_fem_base
  !-----------------------------------------------------------------------------
  !
  !++ Used modules
  !
  ...
  use scale_fem_meshfield_base, only: MeshFieldBase, MeshField1D, MeshField2D, MeshField3D
...
end module scale_file_fem_base