!> module File / FEM meshfield data / Common
!!
!! @par Description
...
module scale_file_fem_common
  ...
  use scale_fem_mesh_base, only: MeshDimInfo
  ...
  use scale_fem_meshfield_base, only: MeshField1D, MeshField2D, MeshField3D
...
!OCL SERIAL
  subroutine File_common_meshfield_get_dims3D( mesh3D, dimsinfo )
    ...
    call set_dimension( dimsinfo(MeshBase3D_DIMTYPEID_Z),    &
      diminfo_z, "FEM_Z", 1, (/ diminfo_z%name /), (/ k_size /), &
    ...
    call set_dimension( dimsinfo(MeshBase3D_DIMTYPEID_ZT), &
      diminfo, "FEM_ZT", 1, (/ diminfo_z%name /), (/ k_size /) )
    ...
    call set_dimension( dimsinfo(MeshBase3D_DIMTYPEID_XYZ), &
      diminfo, "FEM_XYZ", 3, (/ diminfo_x%name, diminfo_y%name, diminfo_z%name /), &
    ...
    call set_dimension( dimsinfo(MeshBase3D_DIMTYPEID_XYZT), &
      diminfo, "FEM_XYZT", 3, (/ diminfo_x%name, diminfo_y%name, diminfo_z%name /), &
      (/ i_size, j_size, k_size /) )
...
end module scale_file_fem_common