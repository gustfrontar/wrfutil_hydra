...
contains
  ...
  subroutine FILE_GrADS_open( &
    ...
    integer                :: nz               ! optional
    integer                :: nt               ! optional
    character(len=H_SHORT) :: endian           ! option for "map"
  ...
  subroutine FILE_GrADS_get_nt( &
    ...
    return
  end subroutine FILE_GrADS_get_nt
  !-----------------------------------------------------------------------------
  ...
  subroutine FILE_GrADS_read_data( &
    ...
    abstract interface
       subroutine rd( fid, pos, nx, cz, k, sx, cx, cy, yrev, endian, var, ierr )
         use scale_precision
    ...
    case("map")
       ...
       do k = 1, count_(1)
          ...
          call read_data( fid, pos, ka, var_info%nx, k, start_(2), count_(2), count_(3), var_info%yrev, var_info%endian, var(:), ierr )
          if ( ierr /= 0 ) then
  ...
  subroutine read_data_int1( fid, pos, ka, nx, k, sx, cx, cy, yrev, endian, var, ierr )
    integer,    intent(in) :: fid
    integer(8), intent(in) :: pos
  ...
  subroutine read_data_int2( fid, pos, ka, nx, k, sx, cx, cy, yrev, endian, var, ierr )
    integer,    intent(in) :: fid
    integer(8), intent(in) :: pos
    integer,    intent(in) :: ka, nx, k, sx, cx, cy
    logical,    intent(in) :: yrev
    ...
    if ( endian == 0 ) then
       !$omp parallel do private(bytes)
       do j = 1, cy
       do i = 1, nx
          bytes(:,1) = transfer(buf(i,j), bytes(:,1))
          do n = 1, 2
             bytes(n,2) = bytes(3-n,1)
          end do
          buf(i,j) = transfer(bytes(:,2), buf(1,1))
       end do
       end do
    end if
  ...
  subroutine read_data_int4( fid, pos, ka, nx, k, sx, cx, cy, yrev, endian, var, ierr )
    integer,    intent(in) :: fid
    integer(8), intent(in) :: pos
    integer,    intent(in) :: ka, nx, k, sx, cx, cy
    logical,    intent(in) :: yrev
  ...
  subroutine read_data_real4( fid, pos, ka, nx, k, sx, cx, cy, yrev, endian, var, ierr )
    integer,    intent(in) :: fid
    integer(8), intent(in) :: pos
    integer,    intent(in) :: ka, nx, k, sx, cx, cy
    logical,    intent(in) :: yrev
  ...
  subroutine read_data_int8( fid, pos, ka, nx, k, sx, cx, cy, yrev, endian, var, ierr )
    integer,    intent(in) :: fid
    integer(8), intent(in) :: pos
    integer,    intent(in) :: ka, nx, k, sx, cx, cy
    logical,    intent(in) :: yrev
  ...
  subroutine read_data_real8( fid, pos, ka, nx, k, sx, cx, cy, yrev, endian, var, ierr )
    integer,    intent(in) :: fid
    integer(8), intent(in) :: pos
    integer,    intent(in) :: ka, nx, k, sx, cx, cy
    logical,    intent(in) :: yrev
