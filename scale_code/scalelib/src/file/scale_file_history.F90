...
module scale_file_history
  ...
  interface FILE_HISTORY_Query_f
     module procedure FILE_HISTORY_Query_NAME_func
     module procedure FILE_HISTORY_Query_ID_func
  end interface FILE_HISTORY_Query_f
  ...
  procedure(truncate_1D), pointer :: FILE_HISTORY_truncate_1D_default => FILE_HISTORY_truncate_1D_default_
  public :: FILE_HISTORY_truncate_1D_default
  abstract interface
  ...
  procedure(truncate_2D), pointer :: FILE_HISTORY_truncate_2D_default => FILE_HISTORY_truncate_2D_default_
  public :: FILE_HISTORY_truncate_2D_default
  abstract interface
  ...
  procedure(truncate_3D), pointer :: FILE_HISTORY_truncate_3D_default => FILE_HISTORY_truncate_3D_default_
  public :: FILE_HISTORY_truncate_3D_default
  abstract interface
  ...
  procedure(truncate_4D), pointer :: FILE_HISTORY_truncate_4D_default => FILE_HISTORY_truncate_4D_default_
  public :: FILE_HISTORY_truncate_4D_default
...
contains
  ...
  subroutine FILE_HISTORY_Put_1D( &
    ...
    integer,  intent(in) :: itemid
    real(RP), intent(in) :: var(:)
    procedure(truncate_1D), optional, pointer :: truncate
    integer :: dimid
    real(DP), allocatable :: buffer(:)
    real(DP) :: dt
    integer  :: idx
    ...
    intrinsic shape
    procedure(truncate_1D), pointer :: truncate_
    !---------------------------------------------------------------------------
    ...
    if ( present(truncate) ) then
      ...
      truncate_ => FILE_HISTORY_truncate_1D
    end if
  ...
  subroutine FILE_HISTORY_Put_2D( &
    ...
    integer,  intent(in) :: itemid
    real(RP), intent(in) :: var(:,:)
    procedure(truncate_2D), optional, pointer :: truncate
    integer :: dimid
    real(DP), allocatable :: buffer(:)
    real(DP) :: dt
    integer  :: idx
    ...
    intrinsic shape
    procedure(truncate_2D), pointer :: truncate_
    !---------------------------------------------------------------------------
    ...
    if ( present(truncate) ) then
      ...
      truncate_ => FILE_HISTORY_truncate_2D
    end if
  ...
  subroutine FILE_HISTORY_Put_3D( &
    ...
    integer,  intent(in) :: itemid
    real(RP), intent(in) :: var(:,:,:)
    procedure(truncate_3D), optional, pointer :: truncate
    integer :: dimid
    real(DP), allocatable :: buffer(:)
    real(DP) :: dt
    integer  :: idx
    ...
    intrinsic shape
    procedure(truncate_3D), pointer :: truncate_
    !---------------------------------------------------------------------------
    ...
    if ( present(truncate) ) then
      ...
      truncate_ => FILE_HISTORY_truncate_3D
    end if
  ...
  subroutine FILE_HISTORY_Put_4D( &
    ...
    integer,  intent(in) :: itemid
    real(RP), intent(in) :: var(:,:,:,:)
    procedure(truncate_4D), optional, pointer :: truncate
    integer :: dimid
    real(DP), allocatable :: buffer(:)
    real(DP) :: dt
    integer  :: idx
    ...
    intrinsic shape
    procedure(truncate_4D), pointer :: truncate_
    !---------------------------------------------------------------------------
    ...
    if ( present(truncate) ) then
      ...
      truncate_ => FILE_HISTORY_truncate_4D
    end if
  ...
  function FILE_HISTORY_Query_ID_func( itemid )
    integer, intent(in) :: itemid
    logical :: FILE_HISTORY_Query_ID_func
    !---------------------------------------------------------------------------

    call FILE_HISTORY_Query_ID( itemid, FILE_HISTORY_Query_ID_func )
  end function FILE_HISTORY_Query_ID_func

  function FILE_HISTORY_Query_Name_func( name )
    character(len=*), intent(in) :: name
    logical :: FILE_HISTORY_Query_Name_func
    !---------------------------------------------------------------------------

    call FILE_HISTORY_Query_Name( name, FILE_HISTORY_Query_Name_func )
  end function FILE_HISTORY_Query_Name_func
  ...
  subroutine FILE_HISTORY_truncate_1D_default_( &
       src, &
    ...
    return
  end subroutine FILE_HISTORY_truncate_1D_default_
  subroutine FILE_HISTORY_truncate_2D_default_( &
       src, &
       dim_type, zcoord, fill_halo, &
       dsc )
    real(RP),         intent(in) :: src(:,:)
    ...
    return
  end subroutine FILE_HISTORY_truncate_2D_default_
  subroutine FILE_HISTORY_truncate_3D_default_( &
       src, &
       dim_type, zcoord, fill_halo, &
       dsc )
    real(RP),         intent(in) :: src(:,:,:)
    ...
    return
  end subroutine FILE_HISTORY_truncate_3D_default_
  subroutine FILE_HISTORY_truncate_4D_default_( &
       src, &
       dim_type, zcoord, fill_halo, &
       dsc )
    real(RP),         intent(in) :: src(:,:,:,:)
    ...
    return
  end subroutine FILE_HISTORY_truncate_4D_default_
