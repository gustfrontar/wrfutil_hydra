!> module common / FEM element / Quadrilateral
!!
!! @par Description
...
!<
#include "scalelib.h"
module scale_fem_element_quadrilateral
  ...
  subroutine construct_Element(elem)
    ...
    do f=1, elem%Nfaces
      ...
      if (elem%IsLumpedMatrix()) then
        ...
        MassEdge(:,:) = MATRIX_inv(matmul(V1D, transpose(V1D)))
      end if
...
end module scale_fem_element_quadrilateral