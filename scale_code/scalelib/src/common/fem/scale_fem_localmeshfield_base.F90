!> module common / FEM local mesh data / base
!!
!! @par Description
...
!<
#include "scalelib.h"
module scale_fem_localmeshfield_base
...
!OCL SERIAL
  subroutine LocalMeshField1D_Init( this, mesh, data_type )
    ...
    LOG_ERROR('LocalMeshField1D_Init',*) 'GCC version should be >= 5! STOP.'
    call PRC_abort
#else
    this%mesh => mesh
#endif
...
end module scale_fem_localmeshfield_base