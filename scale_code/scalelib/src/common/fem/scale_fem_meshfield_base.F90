...
!<
#include "scalelib.h"
module scale_fem_meshfield_base
...
!OCL SERIAL
  subroutine MeshField1D_Init( this, varname, units, mesh, data_type, &
    ...
    real(RP), intent(in), optional :: fill_value
...
end module scale_fem_meshfield_base