!> module common / FEM mesh / base 3D
!!
!! @par Description
...
module scale_fem_mesh_base3d
  ...
  contains
    ...
    procedure(MeshBase3D_set_geometric_with_hcoord), deferred :: Set_geometric_with_hcoord
  ...
  interface 
    ...
    subroutine MeshBase3D_set_geometric_with_hcoord(this, lcdomID, h1_lc, h2_lc)
      import RP
      import MeshBase3D
      class(MeshBase3D), intent(inout), target :: this
      integer, intent(in) :: lcdomID
      real(RP), intent(in) :: h1_lc(this%lcmesh_list(lcdomID)%lcmesh2D%refElem2D%Np,this%lcmesh_list(lcdomID)%lcmesh2D%NeA)
      real(RP), intent(in) :: h2_lc(this%lcmesh_list(lcdomID)%lcmesh2D%refElem2D%Np,this%lcmesh_list(lcdomID)%lcmesh2D%NeA)
    end subroutine MeshBase3D_set_geometric_with_hcoord
...
!OCL SERIAL
  subroutine MeshBase3D_Init(this,        &
    ...
    LOG_ERROR('MeshBase3D_Init',*) 'GCC version should be >= 5! STOP.'
    call PRC_abort
#else
    ...
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_X, "FEM_x", "m", "X-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_Y, "FEM_y", "m", "Y-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_Z, "FEM_z", "m", "Z-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_ZT, "FEM_z", "m", "Z-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_XY, "FEM_xy", "m", "XY-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_XYT, "FEM_xyt", "m", "XY-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_XYZ, "FEM_xyz", "m", "XYZ-coordinate" )
    call this%SetDimInfo( MeshBase3D_DIMTYPEID_XYZT, "FEM_xyzt", "m", "XYZ-coordinate" )
...
end module scale_fem_mesh_base3d