!> module common / FEM communication / 2D
!!
!! @par Description
!!           A module for managing data communication with FEM 
!!
!! @author Yuta Kawai, Team SCALE
!!
!<
#include "scalelib.h"
module scale_comm_fem_meshfield_rectdom2d
  ...
  use scale_fem_meshfield_base, only: MeshField2D
...
end module scale_comm_fem_meshfield_rectdom2d