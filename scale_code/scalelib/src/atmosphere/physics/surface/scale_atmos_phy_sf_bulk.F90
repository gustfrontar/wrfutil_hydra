...
module scale_atmos_phy_sf_bulk
  ...
  logical,  private :: ATMOS_PHY_SF_BULK_heat_const = .false.
  real(RP), private :: ATMOS_PHY_SF_BULK_const_lh = 0.0_RP
  real(RP), private :: ATMOS_PHY_SF_BULK_const_sh = 0.0_RP
...
contains
  ...
  subroutine ATMOS_PHY_SF_bulk_setup
    ...
    namelist / PARAM_ATMOS_PHY_SF_BULK / &
       ...
       ATMOS_PHY_SF_BULK_heat_const, &
       ATMOS_PHY_SF_BULK_const_lh, &
       ATMOS_PHY_SF_BULK_const_sh
  ...
  subroutine ATMOS_PHY_SF_bulk_flux( &
    ...
    !$omp         ATMOS_PHY_SF_BULK_heat_const, &
    !$omp         ATMOS_PHY_SF_BULK_const_sh,ATMOS_PHY_SF_BULK_const_lh, &
    ...
    do i = IS, IE
       ...
       !-----< heat flux >-----
       if ( ATMOS_PHY_SF_BULK_heat_const ) then
          SFLX_SH(i,j) = ATMOS_PHY_SF_BULK_const_sh
          SFLX_LH(i,j) = ATMOS_PHY_SF_BULK_const_lh
       else
