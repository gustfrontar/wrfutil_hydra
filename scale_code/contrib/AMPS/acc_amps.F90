Module acc_amps
  ...
  integer, parameter  :: DS = kind(1d0)
  ! just real(4)
  !integer, parameter  :: PS = SELECTED_REAL_KIND(6, 37)
  !integer, parameter  :: PS = SELECTED_REAL_KIND(15, 307)
#ifdef SINGLE
  integer, parameter  :: PS = kind(1e0)
  integer, parameter  :: MP_KIND = 4
  integer, parameter  :: PS_KIND = 4

  integer, parameter  :: RP = PS
#else
  integer, parameter  :: PS = kind(1d0)
  integer, parameter  :: MP_KIND = 8
  integer, parameter  :: PS_KIND = 8

  integer, parameter  :: RP = DS
#endif
