...
!!       qvs_sd = epsva * es_sd / ( p_sd - es_sd )
       ...
       qd_sd = 1.0_RP-qv_sd
       call ATMOS_SATURATION_pres2qsat_liq( t_sd,p_sd,qd_sd,qvs_sd)
       call ATMOS_SATURATION_psat_liq( t_sd, es_sd )
       ...
       tdeg = t_sd - t0 
       Heat_dry   = (( 5.69d0 + 1.68d-2 * tdeg ) * 1.0d-5 )  ! Thermal conductivity of dry air [cal/(cm*s*C)]
       Heat_vapor = (( 3.73d0 + 2.00d-2 * tdeg ) * 1.0d-5 )  ! Thermal conductivity of vapor [cal/(cm*s*C)]
