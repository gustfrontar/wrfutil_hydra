...
!!$  real(RP), allocatable, save :: rhoa_sdm(:,:,:) ! density of aerosol
  real(DP), allocatable, save :: rand_s2c(:)
  ...
  real(RP), allocatable, save :: QHYD_sdm(:,:,:,:)
  integer, parameter :: I_QHC_sdm=1, & ! index for QHYD_sdm
                      & I_QHR_sdm=2, &
                      & I_QHI_sdm=3, &
                      & I_QHS_sdm=4, &
                      & I_QHG_sdm=5
  integer, parameter :: QHA_sdm=5      ! number of hydrometeor categorieze diagnosed in SDM
  integer, save :: I_QV_sdm  ! index of QV in QTRC in SDM modules
  integer, save :: QA_MP_sdm ! number of tracers in QTRC in SDM modules
...
!  integer, parameter :: nqw = QQA
  ...
  integer, save :: sdm_wbc=1 ! 1:periodic/no inflow boundary, 2:inflow
  integer, save :: sdm_ebc=1 ! 1:periodic/no inflow boundary, 2:inflow
  integer, save :: sdm_sbc=1 ! 1:periodic/no inflow boundary, 2:inflow
  integer, save :: sdm_nbc=1 ! 1:periodic/no inflow boundary, 2:inflow
...
!!$  integer,  allocatable, save :: KPLS1(:), IPLS1(:), JPLS1(:)
  ...
  logical, save :: docollision = .true.
  logical, save :: dosedimentation  = .true.
