...
contains
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_boundary(sdm_wbc,sdm_ebc,sdm_sbc,sdm_nbc,                         &
    ...
    call sdm_putbufsx(sdm_wbc,sdm_ebc,sd_num,sd_numasl,              &
    ...
    call sdm_getbufsx(sdm_wbc,sdm_ebc,sd_num,sd_numasl,              &
            sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz,    &
            sd_r,sd_asl,sdi,                               &
            bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            stat,sd_itmp1,                            &
    ...
    call sdm_putbufsy(sdm_sbc,sdm_nbc,sd_num,sd_numasl,              &
            sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz,    &
            sd_r,sd_asl,sdi,                               &
            bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            stat,sd_itmp1,                            &
    ...
    call sdm_getbufsy(sdm_sbc,sdm_nbc,sd_num,sd_numasl,              &
            sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz,    &
            sd_r,sd_asl,sdi,                               &
            bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            stat,sd_itmp1,                            &
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_putbufsx(sdm_wbc,sdm_ebc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                           &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                   &
  ...
  !--------------------------------------------------------------------------
  subroutine sdm_getbufsx(sdm_wbc,sdm_ebc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                            &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                               &
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_putbufsy(sdm_sbc,sdm_nbc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                           &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                   &
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_getbufsy(sdm_sbc,sdm_nbc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                            &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                               &
