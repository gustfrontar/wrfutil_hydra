...
!! @li      2022-04-26 (S.Shima) [mod] enable nonperiodic boundary for SDM
!!
!<
!-------------------------------------------------------------------------------
#include "scalelib.h"
...
contains
  ...
  subroutine sdm_boundary(  &
    ...
    integer, intent(in) :: sdm_wbc ! Option for west boundary conditions
    integer, intent(in) :: sdm_ebc ! Option for east boundary conditions
    integer, intent(in) :: sdm_sbc ! Option for south boundary conditions
    integer, intent(in) :: sdm_nbc ! Option for north boundary conditions
    integer, intent(in) :: sd_num ! number of super-droplets
    ...
    call sdm_putbufsx(IS,IE,sdm_wbc,sdm_ebc,sd_num,sd_numasl,              &
    ...
    call sdm_shiftsx(sdm_wbc,sdm_ebc,bufsiz1, &
            bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            sbuf_r8,rbuf_r8,sbuf_i8,rbuf_i8,sbuf_i2,rbuf_i2,sbuf_i4,rbuf_i4)

    call sdm_getbufsx(IS,IE,sdm_wbc,sdm_ebc,sd_num,sd_numasl,              &
            sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz,    &
            sd_r,sd_asl,sdi,                               &
            bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            stat,sd_itmp1,                            &
    ...
    call sdm_putbufsy(JS,JE,sdm_sbc,sdm_nbc,sd_num,sd_numasl,              &
            sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz,    &
            sd_r,sd_asl,sdi,                               &
            bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            stat,sd_itmp1,                            &
    ...
    ! In case of exsiting outflow super-droplets
    call sdm_shiftsy(sdm_sbc,sdm_nbc,bufsiz1,      &
            bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            sbuf_r8,rbuf_r8,sbuf_i8,rbuf_i8,sbuf_i2,rbuf_i2,sbuf_i4,rbuf_i4)
       
    call sdm_getbufsy(JS,JE,sdm_sbc,sdm_nbc,sd_num,sd_numasl,              &
            sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz,    &
            sd_r,sd_asl,sdi,                               &
            bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
            stat,sd_itmp1,                            &
    ...
    if( stat /= 0 ) then
       LOG_ERROR("sdm_boundary",*) "send/receive error of super-droplets"
       call PRC_abort
    end if
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_putbufsx(IS,IE,sdm_wbc,sdm_ebc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                           &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                   &
    ...
    use m_sdm_common, only: &
         INVALID,INVALID_i8,INVALID_i2,VALID2INVALID,i2,sdm_cold,sdicedef

    ! Input variables
    integer, intent(in) :: IS,IE
    integer, intent(in) :: sdm_wbc    ! Option for west boundary conditions
    integer, intent(in) :: sdm_ebc    ! Option for east boundaty conditions
    integer, intent(in) :: sd_num ! number of super-droplets
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_shiftsx(sdm_wbc,sdm_ebc,           &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4,&
       sbuf_r8,rbuf_r8,sbuf_i8,rbuf_i8,sbuf_i2,rbuf_i2,sbuf_i4,rbuf_i4)
    use mpi
    use scale_prc, only: &
  ...
  !--------------------------------------------------------------------------
  subroutine sdm_getbufsx(IS,IE,sdm_wbc,sdm_ebc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                            &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                               &
    ...
    use scale_atmos_grid_cartesC, only: &
         GRID_FX => ATMOS_GRID_CARTESC_FX
    use m_sdm_common, only: &
         VALID2INVALID,VALID2INVALID_i8,i2,sdm_cold,sdicedef
    ! Input variables
    integer, intent(in) :: IS, IE
    integer, intent(in) :: sdm_wbc       ! Option for west boundary conditions
    integer, intent(in) :: sdm_ebc       ! Option for east boundaty conditions
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_putbufsy(JS,JE,sdm_sbc,sdm_nbc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                           &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                   &
    ...
    integer, intent(in) :: sdm_sbc   ! Option for west boundary conditions
    integer, intent(in) :: sdm_nbc   ! Option for east boundaty conditions
    integer, intent(in) :: sd_num  ! number of super-droplets
    integer, intent(in) :: sd_numasl ! number of kind of chemical materia contained as water-soluble aerosol in super droplets
    integer(DP), intent(in) :: sd_n(1:sd_num)   ! multiplicity of super-droplets
    integer(i2), intent(in) :: sd_liqice(1:sd_num)
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_shiftsy(sdm_sbc,sdm_nbc,               &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4,&
       sbuf_r8,rbuf_r8,sbuf_i8,rbuf_i8,sbuf_i2,rbuf_i2,sbuf_i4,rbuf_i4)
    use mpi
    use m_sdm_common, only: &
    ...
    ! Input variables
    integer, intent(in) :: sdm_sbc      ! Option for south boundary conditions
    integer, intent(in) :: sdm_nbc      ! Option for north boundaty conditions
    integer, intent(in) :: bufsiz1  ! buffer size for MPI
     integer, intent(in) :: bufsiz2_r8 ! buffer size for MPI (real8)
    integer, intent(in) :: bufsiz2_i8 ! buffer size for MPI (int8)
    integer, intent(in) :: bufsiz2_i2 ! buffer size for MPI (int2)
  ...
  !----------------------------------------------------------------------------
  subroutine sdm_getbufsy(JS,JE,sdm_sbc,sdm_nbc,sd_num,sd_numasl,         &
       sd_n,sd_liqice,sd_x,sd_y,sd_rk,sd_u,sd_v,sd_vz, &
       sd_r,sd_asl,sdi,                            &
       bufsiz1,bufsiz2_r8,bufsiz2_i8,bufsiz2_i2,bufsiz2_i4, &
       stat,ilist,                               &
