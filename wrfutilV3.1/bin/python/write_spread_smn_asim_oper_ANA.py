...
# ANAFILES     - Path absoluto de los analisis de todos los miembros
#		ej: export ANAFILES=$(ls /data/yanina/wrfutilV3.1/RUNs/HIST/POST/20200102_060000/prueba/*ANA* )
...
###################
description_short = 'ASP'
description_long = 'Square of Analysis Spread [ 1/(R-1) sum (Xme-Xi)2 ], i={1...R} ens members'
