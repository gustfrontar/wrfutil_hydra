...
MODELDATAPATH=/home/pmaldonado/WRF_CONTROL_RUN/
OBSPATH=$MODELDATAPATH/OBS_0.0ms_0db_noerror/
RADARFILE=""
...
MODELFILE=$MODELDATAPATH/wrfout_d01_${YY}-${MM}-${DD}_${ihh}:${imm}:${iss}
...
./model_to_radar_invap_noerror.exe
