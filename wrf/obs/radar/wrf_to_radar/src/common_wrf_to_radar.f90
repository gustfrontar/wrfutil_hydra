...
!  REAL(r_size), PARAMETER :: minz=0.01d0 , 
  ...
  !Observational error. This section controls the random error added to the
  !observations.
  LOGICAL            :: ADD_OBS_ERROR=.FALSE.
  
  REAL(r_size)       :: REFLECTIVITY_ERROR=5.0 !Standard deviation of reflectivity error in DBZ
  REAL(r_size)       :: RADIALWIND_ERROR=1.0   !Standard deviation of radialwind error in m/s
