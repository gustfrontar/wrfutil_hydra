...
!-----------------------------------------------------------------------
  ...
  !A value of 6370 for RE is used in the WRF map routines. So this value 
  !produce a more accurate lat,lon - i,j transformation. 
  REAL(r_size),PARAMETER :: re=6370.0d3            !6371.3d3
  REAL(r_size),PARAMETER :: r_omega=7.292d-5
  REAL(r_size),PARAMETER :: t0c=273.15d0
  REAL(r_size),PARAMETER :: undef=9.99d33
  REAL(r_size),PARAMETER :: deg2rad=3.141592653589793d0/180d0
  REAL(r_size),PARAMETER :: rad2deg=180d0/3.141592653589793d0
