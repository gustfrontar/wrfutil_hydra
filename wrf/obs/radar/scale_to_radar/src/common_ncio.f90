...
! Open a netcdf file
!-----------------------------------------------------------------------
subroutine ncio_get_dim(ncid, dimname , dimlen )
  implicit none
  character(len=*), intent(in) :: dimname
  character(len=20)            :: tmpdimname
  integer, intent(in)  :: ncid 
  integer, intent(out) :: dimlen
  integer              :: dimid

  call ncio_check(nf90_inq_dimid(ncid, dimname , dimid ))
  call ncio_check(nf90_inquire_dimension( ncid , dimid , tmpdimname , dimlen ))
end subroutine ncio_get_dim
!-----------------------------------------------------------------------
! Close a netcdf file
!-----------------------------------------------------------------------
...
subroutine ncio_read_2d_r8(ncid, varname, dim1, dim2, t, var)
  ...
  character(len=*), intent(in) :: varname
  integer, intent(in) :: dim1, dim2, t
  real(r_size), intent(out) :: var(dim1,dim2)
  integer :: varid
...
subroutine ncio_read_3d_r8(ncid, varname, dim1, dim2, dim3, t, var)
  ...
  character(len=*), intent(in) :: varname
  integer, intent(in) :: dim1, dim2, dim3, t
  real(r_size), intent(out) :: var(dim1,dim2,dim3)
  integer :: varid
...
subroutine ncio_write_1d_r8(ncid, varname, dim1, t, var)
  ...
  character(len=*), intent(in) :: varname
  integer, intent(in) :: dim1, t
  real(r_size), intent(in) :: var(dim1)
  integer :: varid
...
subroutine ncio_write_2d_r8(ncid, varname, dim1, dim2, t, var)
  ...
  character(len=*), intent(in) :: varname
  integer, intent(in) :: dim1, dim2, t
  real(r_size), intent(in) :: var(dim1,dim2)
  integer :: varid
...
subroutine ncio_write_3d_r8(ncid, varname, dim1, dim2, dim3, t, var)
  ...
  character(len=*), intent(in) :: varname
  integer, intent(in) :: dim1, dim2, dim3, t
  real(r_size), intent(in) :: var(dim1,dim2,dim3)
  integer :: varid
