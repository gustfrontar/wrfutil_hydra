...
TMPDIR=/data1/jruiz/TMP/covariance_matrix_1000m_gues_histogram_nosmooht/                      #Temporary work directory.
...
source /home/jruiz/share/LETKF_WRF/wrf/run/util.sh

#Create temporary folder
mkdir -p $TMPDIR
cp /home/jruiz/share/LETKF_WRF/wrf/verification/covmatrix/*.exe $TMPDIR
