...
!  WRITE(*,*)"TERMINE DE LEER EL ENSEMBLE"
  !
...
!  WRITE(*,*)"TERMINE DE ESCRIBIR LA MEDIA DEL ENSAMBLE"
!
  CALL CPU_TIME(rtimer)
...
!  WRITE(*,*)"TERMINE DE ESCRIBIR LA MEDIA DEL ANALYSIS"
