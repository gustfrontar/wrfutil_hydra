...
do
 ...
 do 
  ...
  wgrib2 $ORIGINALDIR/pgbh00.gdas.${ANIO}${MES}${DIA}${HORA}.grb2 -set_grib_type jpeg -match ":(UGRD:10 m above ground|VGRD:10 m above ground|TMP:2 m above ground|RH:2 m above ground|SOILW|TSOIL|LAND|ICEC|WEASD|TMP:0-0.1 m below ground|TMP:0.1-0.4 m below ground|TMP:0.4-1 m below ground|TMP:1-2 m below ground|TMP:surface):" -small_grib $LONRANGE $LATRANGE ./grib1 > log1.log
  ...
  wgrib2 ./grib2  -append -set_grib_type jpeg -grib ./grib1  > ./log3.log
