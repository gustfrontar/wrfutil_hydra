...
BOUNDARY_DATA_FREQO=21600       #We can chose to output met_em at a higher frequency using ungrib interp.


IE=20100801000000   #Experiment initial date.
EE=20100930180000   #Experiment end date.
