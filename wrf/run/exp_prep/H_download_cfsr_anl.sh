...
ITIME=19980417000000   #Start Time (yyyymmddhhMMss)
...
mkdir -p  $DESTDIR
curl https://nomads.ncdc.noaa.gov/modeldata/cmd_pgbh/$YEAR/${YEAR}${MONTH}/${YEAR}${MONTH}${DAY}/pgbhnl.gdas.${YEAR}${MONTH}${DAY}${TIME}.grb2 -o $DESTDIR/pgbhnl.gdas.${YEAR}${MONTH}${DAY}${TIME}.grb2
