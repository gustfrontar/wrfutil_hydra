...
#CONFIGURATION
CONFIGURATION=ensemble_forecast_pbl_ysu_Hydra #Define a experiment configuration
MCONFIGURATION=machine_pbl_Hydra_multiple                     #Define a machine configuration (number of nodes, etc)
