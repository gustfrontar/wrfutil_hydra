...
#CONFIGURATION
CONFIGURATION=control_paranafnl10k_60m_radar_grib_Hydra    #Define a experiment configuration
MCONFIGURATION=machine_test                                #Define a machine configuration (number of nodes, etc)
