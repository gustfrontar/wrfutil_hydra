...
#CONFIGURATION
CONFIGURATION=control_run_ensemble_from_global_europe	#Define a experiment configuration
MCONFIGURATION=machine_run_ensemble_from_global_europe  #Define a machine configuration (number of nodes, etc)
