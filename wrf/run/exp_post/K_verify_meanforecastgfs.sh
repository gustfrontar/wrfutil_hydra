...
TMPDIRVERIF=$HOME/data/TMP/VERIFICATION_FOR_3
DO_OBSGRID=".true."
...
NBSLOT=01
VINIDATE=20080923120000
VENDDATE=20080930000000
VMAX_RUNNING=1


#CONFIGURATION
DOMAINCONF=SINLAKU_60K                              #Define a domain
CONFIGURATION=meanforecastgfs                       #Define a experiment configuration
...
time postproc_global_analysis $CDATE $FDATE

echo '>>>'
echo ">>> ANALYSIS VERIFICATION USING GLOBAL ANALYSIS "
echo '>>>'

time verification_against_global_analysis $CDATE $FDATE

echo " >>"
echo " >> ANALYSIS VERIFICATION USING OBSERVATIONS "
echo " >>"

time verification_against_obs $CDATE $FDATE
