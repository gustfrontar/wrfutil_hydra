...
NODES_PER_MEMBER=40 #Number of nodes per ensemble member.
...
ELAPSE="03:00:00"   #MAXIMUM ELAPSE TIME (MODIFY ACCORDING TO THE SIZE OF THE DOMAIN AND THE RESOLUTION)
...
TOTAL_NODES_FORECAST=5120
TOTAL_NODES_LETKF=5120
