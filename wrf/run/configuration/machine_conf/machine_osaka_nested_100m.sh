...
ELAPSE="01:30:00"   #MAXIMUM ELAPSE TIME (MODIFY ACCORDING TO THE SIZE OF THE DOMAIN AND THE RESOLUTION)
...
MAX_MEMBER_PER_JOB=4    #Number of members included on each job.
MAX_SUBMITT_JOB=5       #Maximum number of jobs that can be submitted to the queue.
