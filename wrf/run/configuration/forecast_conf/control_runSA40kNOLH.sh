...
OUTVARS="'geopt,umet,vmet,W,QVAPOR,RAINNC,RAINC,tk,u10m,v10m,slp,mcape,mcin,H_DIABATIC,RTHSHTEN,RTHCUTEN,RQVCUTEN,RTHFTEN,RTHRATLW,RTHRATSW,RUBLTEN,RVBLTEN,RTHBLTEN,HFX,LH'"
