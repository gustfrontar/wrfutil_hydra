...
OUTVARS="'GEOPT,umet,vmet,W,QVAPOR,QCLOUD,QRAIN,QICE,QSNOW,QGRAUP,RAINNC,RAINC,tk,u10m,v10m,slp,mcape,mcine,h_diabatic,RUSHTEN,RVSHTEN,RQVSHTEN,RTHSHTEN,RUCUTEN,RVCUTEN,RTHCUTEN,RQVCUTEN,RTHFTEN,RQVFTEN,RTHRATLW,RTHRATSW,RUBLTEN,RVBLTEN,RTHBLTEN,RUBLTEN'"
