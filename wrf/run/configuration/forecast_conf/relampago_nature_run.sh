...
DOMAINCONF=RELAMPAGO_EXP_20181211    #Define a domain
LETKFNAMELIST=control
MEMBER=1   #10     #Number of ensemble members.
MAX_DOM=1
HOMEDIR=${HOME}/share/
DATADIR=${HOME}/data/
...
ASSIMILATION_FREC=3600 #Forecast initialization frequency (seconds)
GUESFT=43200    #604800           #Forecast length (secons)

WINDOW=3600        #Forecast initialization frequency (seconds)
...
WINDOW_FREC=600     #Output frequency for the forecast
...
PERTURB_ATMOSPHERE=".false."   #Wether atmospheric conditions will be perturbed (boundary and first cycle)
PERTURB_SST=".false."          #Wether SST will be perturbed.
PERTURB_SOIL=".false."         #Wether SOIL conditions will be perturbed (soil moisture and soil temperature)
...
IDATE=20181211110000     #EXPERIMENT INITIAL DATE
EDATE=20181211110000     #EXPERIMENT END DATE
