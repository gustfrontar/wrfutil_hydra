...
MEMBER=36           #Number of ensemble members.
MAX_DOM=1
HOMEDIR=${HOME}/share/
DATADIR=${HOME}/data/
...
WINDOW_END=28800    #Window end   (seconds from forecast initialization)
...
OUTVARS="'umet,vmet,W,QVAPOR,q2,t2,RAINC,RAINNC,geopt,tk,u10m,v10m,slp'"
...
### LETKF setting
OBS="/PREPBUFRSA/"                             # Name of observation folder.
EXP=ANALYSIS_${DOMAINCONF}_${CONFIGURATION}    # name of experiment

### initial date setting
IDATE=20100801060000
EDATE=20100930000000
...
SPAWN=$WRF/spawn/
MPIBIN=/home/jruiz/mpich.gfortran/bin/mpiexec
