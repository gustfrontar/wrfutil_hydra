...
SCALE_FACTOR="0.2"         #Perturbation scale factor.
RANDOM_SCALE_FACTOR="0.0"  #Random perturbation scale factor.
PERTURB_BOUNDARY=0         #If boundary conditions will be perturbed continously.
...
OUTVARS="'umet,vmet,W,QVAPOR,PSFC,HGT,TSK,RAINC,RAINNC,SST,geopt,tk,rh,rh2,u10m,v10m,slp,mcape'"
