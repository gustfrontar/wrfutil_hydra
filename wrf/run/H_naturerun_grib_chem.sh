...
#CONFIGURATION
CONFIGURATION=control_run_chem	     #Define a experiment configuration
...
#################### WARNING !!!! ###########################
##VAMOS A USAR EL GEO_EM PRE_CALCULADO CON LA COSTA MODIFICADA

cp $CHEM_DATA/geo_em.d01_modified.nc $TMPDIR/domain/geo_em.d01.nc
