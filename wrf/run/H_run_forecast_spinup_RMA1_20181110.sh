...
#CONFIGURATION
CONFIGURATION=ensemble_forecast_spinup_RMA1_20181110 #Define a experiment configuration
MCONFIGURATION=machine_radar60m_RMA1_20181110        #Define a machine configuration (number of nodes, etc)

RESTART=0
RESTARTDATE=20140122173000
RESTARTITER=10
