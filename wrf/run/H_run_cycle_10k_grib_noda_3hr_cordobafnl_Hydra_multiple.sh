...
#CONFIGURATION
CONFIGURATION=control_cordoba10k_60m_noda_grib_Hydra              #Define a experiment configuration
MCONFIGURATION=machine_radar60m_multiple_Hydra_2nodes             #Define a machine configuration (number of nodes, etc)
