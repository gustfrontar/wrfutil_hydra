...
CLOSE(54)
  ...
  var_local(:,1)=var_local_uv(nv3d+nv2d)
  var_local(:,2)=var_local_t(nv3d+nv2d)
  var_local(:,3)=var_local_tv(nv3d+nv2d)
  var_local(:,4)=var_local_moist(nv3d+nv2d)
  var_local(:,5)=var_local_ps(nv3d+nv2d)
  var_local(:,6)=var_local_ref(nv3d+nv2d)
  var_local(:,7)=var_local_dop(nv3d+nv2d)
  var_local(:,8)=var_local_co(nv3d+nv2d)

  var_local_par(:,1)=var_localp_uv(np2d)
  var_local_par(:,2)=var_localp_t(np2d)
  var_local_par(:,3)=var_localp_tv(np2d)
  var_local_par(:,4)=var_localp_moist(np2d)
  var_local_par(:,5)=var_localp_ps(np2d)
  var_local_par(:,6)=var_localp_ref(np2d)
  var_local_par(:,7)=var_localp_dop(np2d)
  var_local_par(:,8)=var_localp_co(np2d)
