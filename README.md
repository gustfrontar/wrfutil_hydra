...
SCALE: A branch [offlinenest](https://github.com/scale-met/scale-dev/tree/feature/offlinenest) of a private repository [scale-dev](https://github.com/scale-met/scale-dev), with slight modification.   
SCALE-LETKF: A private repository [scale-letkf](https://github.com/SCALE-LETKF-SMN/scale-letkf) of a version for the PREVENIR project. 

[SCALE User's guide](https://scale.riken.jp/archives/scale_users_guide_En.v5.5.2.pdf) is available online.
