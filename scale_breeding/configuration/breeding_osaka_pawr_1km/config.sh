...
ENDDATE=20130713053100   #End date for the breeding cycle.
...
BVDATAROOT="/home/jruiz/share/scale_input_data/OsakaPAR_1km_control100m_smallrandompert/"  #Folder for the initial perturbations and for central trayectory.
...
BREEDING_IN_PLACE=0                      #1 means enable RUNINPLACE, 0 means disable RUNINPLACE.
...
BREEDING_IN_PLACE_ENDDATE=20130713053100 #First date in which running in place will be applied.
...
PRC_NUM_X_IN=5   #Number of subdomains in X to integrate the perturbations.
PRC_NUM_Y_IN=4  #Number of subdomains in Y to integrate the perturbations.
