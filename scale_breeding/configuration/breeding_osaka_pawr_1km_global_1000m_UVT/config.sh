...
ENDDATE=20130713054000   #End date for the breeding cycle.
...
BREEDING_IN_PLACE_IT=5                   #How many run in place iterations will be performed when RUNINPLACE is enabled.
